...
export default function WtcCardV2(props: WtcCardProps) {
	...
	return (
		<div
			ref={preference}
			className={`p-1 d-flex flex-column bg-white ${props.className}`}
			style={{
		...
		>
			{props.title && (
				<div className="d-flex justify-content-between p-1  pt-1">
					<div className={`d-flex fs-5 fw-bold flex-grow-1`}>
						...
						<div className={`align-self-center w-100`} style={{ color: "black" }}>
			...
			{props.body && (
				<div
					...
					style={{ height: height - 70 - (props.footer ? 62 : 0), overflowY: "auto", overflowX: "hidden" }}
				>
					{props.body}
				</div>
			)}
